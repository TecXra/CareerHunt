...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-lg-9" style="height: 550px; overflow-y: scroll;">

			<div class="row" id="job-rows">
				<div class="col-lg-2" style="margin-top: 1%;">
					<img alt="" class="img-responsive" src="{{ asset('img/comp-logo/amazon.jpg')}}" title="Amazon.com">
       			</div>
           		<div class="col-lg-8">
               		<a href="#"><h5>Website Designer</h5></a>
               		<span class="text-danger app-date">Job posted: 26-06-2016</span>
               		<h5><a href="#">Amazon.Com</a></h5>
               	...
               	<div class="col-lg-2" style="margin-top: 0.5%;">
               		<h6 class="blu-blu-text">PKR&nbsp;10,000 <br></h6>
               		<p class="text-muted">Lahore, Pakistan</p>
               		<input class="btn _btn gr-drk" title="Apply job" value="Apply Now" type="button">
               	</div>
			</div>

			<div class="row" id="job-rows">
				<div class="col-lg-2" style="margin-top: 1%;">
					<img alt="" class="img-responsive" src="{{ asset('img/comp-logo/hbl.jpg')}}" title="hbl.com.pk">
       			</div>
           		<div class="col-lg-8">
               		<a href="#"><h5>Data Entry Operator</h5></a>
               		<span class="text-danger app-date">Job posted: 26-06-2016</span>
               		<h5><a href="#">hbl.com.pk</a></h5>
               		<div class="text-muted">
                  		An expert person with minimum 80wpm. Also have ability to do work in...
                  	</div>
                </div>
               	<div class="col-lg-2" style="margin-top: 0.5%;">
               		<h6 class="blu-blu-text">PKR 10,000 <br></h6>
			...
			<div class="row" id="job-rows">
				<div class="col-lg-2" style="margin-top: 1%;">
					<img alt="" class="img-responsive" src="{{ asset('img/comp-logo/dhllogo.png')}}" title="DHL.com">
       			</div>
           		<div class="col-lg-8">
               		<a href="#"><h5>HTV Driver</h5></a>
               		<span class="text-danger app-date">Job posted: 26-06-2016</span>
               		<h5><a href="#">dhl.Com</a></h5>
               		<div class="text-muted">
                  		An expert driver who is regular and capable to manage time of...
                  	</div>
                </div>
               	<div class="col-lg-2" style="margin-top: 0.5%;">
               		<h6 class="blu-blu-text">PKR 10,000 <br></h6>
			...
			<div class="row" id="job-rows">
				<div class="col-lg-2" style="margin-top: 1%;">
					<img alt="" class="img-responsive" src="{{ asset('img/comp-logo/gensoft.jpg')}}" title="gensoft.com.pk">
       			</div>
           		<div class="col-lg-8">
               		<a href="#"><h5>Java Developer</h5></a>
               		<span class="text-danger app-date">Job posted: 26-06-2016</span>
               		<h5><a href="#">gensoft.com.pk</a></h5>
               		<div class="text-muted">
                  	</div>
                </div>
               	<div class="col-lg-2" style="margin-top: 0.5%;">
			...
			<div class="row" id="job-rows">
				<div class="col-lg-2" style="margin-top: 1%;">
					<img alt="" class="img-responsive" src="{{ asset('img/comp-logo/din.jpg')}}" title="dinnews.tv.pk">
       			</div>
           		<div class="col-lg-8">
               		<a href="#"><h5>News Reporter</h5></a>
               		<span class="text-danger app-date">Job posted: 26-06-2016</span>
               		<h5><a href="#">dinnews.tv.pk</a></h5>
               		<div class="text-muted">
                  	</div>
                </div>
               	<div class="col-lg-2" style="margin-top: 0.5%;">
			...
			<div class="row" id="job-rows">
				<div class="col-lg-2" style="margin-top: 1%;">
					<img alt="" class="img-responsive" src="{{ asset('img/comp-logo/warid.png')}}" title="warid.com.pk">
       			</div>
           		<div class="col-lg-8">
               		<a href="#"><h5>Telephone Operator</h5></a>
               		<span class="text-danger app-date">Job posted: 26-06-2016</span>
               		<h5><a href="#">warid.com.pk</a></h5>
               		<div class="text-muted">
                  	</div>
                </div>
               	<div class="col-lg-2" style="margin-top: 0.5%;">
			...
			<div class="row" id="job-rows">
				<div class="col-lg-2" style="margin-top: 1%;">
					<img alt="" class="img-responsive" src="{{ asset('img/comp-logo/softsolutions.png')}}" title="softsolutions.pk">
       			</div>
           		<div class="col-lg-8">
               		<a href="#"><h5>Android Developer</h5></a>
               		<span class="text-danger app-date">Job posted: 26-06-2016</span>
               		<h5><a href="#">softsolutions.pk</a></h5>
               		<div class="text-muted">
                  	</div>
                </div>
               	<div class="col-lg-2" style="margin-top: 0.5%;">
			...
			<div class="row" id="job-rows">
				<div class="col-lg-2" style="margin-top: 1%;">
					<img alt="" class="img-responsive" src="{{ asset('img/comp-logo/ptcl.png')}}" title="ptcl.com.pk">
       			</div>
           		<div class="col-lg-8">
               		<a href="#"><h5>Data Entry Operator</h5></a>
               		<span class="text-danger app-date">Job posted: 26-06-2016</span>
               		<h5><a href="#">ptcl.com.pk</a></h5>
               		<div class="text-muted">
                  	</div>
                </div>
               	<div class="col-lg-2" style="margin-top: 0.5%;">
			...
			<div class="row" id="job-rows">
				<div class="col-lg-2" style="margin-top: 1%;">
					<img alt="" class="img-responsive" src="{{ asset('img/comp-logo/pc-hotel.jpg')}}" title="pc.pk">
       			</div>
           		<div class="col-lg-8">
               		<a href="#"><h5>Hotel Receptionist</h5></a>
               		<span class="text-danger app-date">Job posted: 26-06-2016</span>
               		<h5><a href="#">pc.pk</a></h5>
               		<div class="text-muted">
                  	</div>
                </div>
               	<div class="col-lg-2" style="margin-top: 0.5%;">
			...
			<div class="row" id="job-rows">
				<div class="col-lg-2" style="margin-top: 1%;">
					<img alt="" class="img-responsive" src="{{ asset('img/comp-logo/StarMarketingPvtLtd.jpg')}}" title="StarMarketingPvtLtd.com.pk">
       			</div>
           		<div class="col-lg-8">
               		<a href="#"><h5>SEO Consultant</h5></a>
               		<span class="text-danger app-date">Job posted: 26-06-2016</span>
               		<h5><a href="#">StarMarketingPvtLtd.com.pk</a></h5>
               		<div class="text-muted">
 						A Search Engine Optimization (SEO) Consultant analyzes, reviews and implements changes to websites...
 					</div>
                </div>
               	<div class="col-lg-2" style="margin-top: 0.5%;">
               		<h6 class="blu-blu-text">PKR 10,000 <br></h6>
...
@include('partials.footer2')
	...
	<script type="text/javascript">
	$(function(){
		$('.apply_guest').bind('click', function() {
			$("#ajax_login_link").click();
		});
	});
	</script>

		<script type="text/javascript" src="../../rightjobs-cdn.cargeneral.com/application/modules/apply_job/js/apply-job.js"></script>
	<script type="text/javascript">
	$(function(){
		new applyJobs({
			siteUrl: 'http://rightjobs.pk/',
			idVacancy: '229014',
			useService: '',
			linkId: 'job_apply_229014'
		});
	});
	</script>
