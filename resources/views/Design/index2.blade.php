...
<div class="container-fluid" style="margin-bottom: 1%; margin-top: 1%;">
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1">Search Job Seekers</i></a></li>
        </ul>
...
<!--
        <div class="row" id="tabs-2">
            <div class="jumbotron" style="margin-top: 1%;">
                <div class="container text-center">
                    <h2 id="search-h1">
                        Search online and find Jobs in Pakistan
                    </h2>
                    <form action="#">
                        <div class="col-xs-12 col-sm-3 col-md-3">
                        <div class="form-group">
                            <input class="form-control" placeholder="Search Job Seekers"/>
                        </div>
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3">
                        <div class="form-group">
                            <input class="form-control btn-primary" type="submit" value="Advanced Search"/>
                        </div>
=======
...
>>>>>>> 04ae10d37ff3106291524d680a7e9cdb2b998803
                    </div>
                </form>
            </div> 
        </div>
